 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Ecg_Sniffs_Commenting_ClassCommentSniff extends PEAR_Sniffs_Commenting_FileCommentSniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$prev]['code'] === T_OPEN_TAG) {
            ...
            if ($prevOpen === false) {
                ...
                /**
                 * AOE Change: Actually since File Comments are not widely used in the Magento Community, this is probably a class Comment.
                 */
                //$phpcsFile->addError('Missing class doc comment', $stackPtr, 'Missing');
                return;
            }
